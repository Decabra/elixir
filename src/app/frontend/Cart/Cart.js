                    ...
                    <div className="col-8 shadow rounded bg-white mb-3 pb-3">
                        ...
                        <div className="px-3 pt-2">
                            ...
                            <div className="container-fluid">
                                ...
                                <button className="btn btn-outline-primary d-flex" type="submit"><span className="material-icons">shopping_cart</span>Checkout</button>
                            ...
                            <div className="card-body bg-white">
                                ...
                                <div className="text-center pt-4">
                                    <div className="btn-group gap-2">
                                        <a href="#" className="rounded btn btn-outline-primary btn-md d-flex"><span className="material-icons">shopping_cart</span> Checkout</a>
